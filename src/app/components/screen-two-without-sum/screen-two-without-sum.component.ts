...
@Component({
  selector: 'app-screen-two-without-sum',
  templateUrl: './screen-two-without-sum.component.html',
  styleUrls: ['./screen-two-without-sum.component.css']
})
export class ScreenTwoWithoutSumComponent implements OnInit {
